# ======================================================
# OV9D official single-object camera-frame object pose training
# ======================================================
#
# accelerate launch --num_processes=1 train_omnivggt.py --config configs/train_oo9d_official.py


output_dir = "outputs"
exp_name = "oo9d_official_camera_pose_size_mask_presence"
logging_dir = "logs"
...
model_url = "/omni_vggt/model.safetensors"
...
# oo9d_split_root = f"{omni_root}/splits_ov9d_official"
# oo9d_object_image_root = f"{freepose_root}/ov9d/ov9d_around_image"

#* Remote server layout:
omni_root = "/omni-object_ov9d_official"
oo9d_root = "/dataset/ov9d"
oo9d_single_root = f"{oo9d_root}/oo3d9dsingle"
oo9d_split_root = f"{omni_root}/splits_ov9d_official"
...
train_dataset = (
    ...
    f"single_split_json='{oo9d_split_root}/train.json', "
...
val_dataset = (
    ...
    "dset='val', "
    f"single_root='{oo9d_single_root}', "
    f"single_split_json='{oo9d_split_root}/test1.json', "
    f"object_image_root='{oo9d_object_image_root}', "
    "num_object_views=4, "
    f"fixed_object_view_ids={fixed_object_view_ids}, "
    f"strict_fixed_object_view_ids={strict_fixed_object_view_ids}, "
