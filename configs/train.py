...
# accelerate launch --num_processes=1 train_omnivggt.py --config configs/train.py

# accelerate launch --num_processes=4 train_omnivggt.py \
#   --config configs/train.py \
#   --val_only \
#   --resume_model_path /mnt/train-data-4-hdd/yian/freepose/omni-object/outputs/0421_4000scene/12000/model.safetensors
...
model_url = "/mnt/train-data-4-hdd/yian/freepose/omni-object/outputs/0421_4000scene/12000/model.safetensors"
...
max_grad_norm = 1.0
debug_print_object_paths = True
debug_print_object_paths_steps = 1
debug_print_object_paths_max_samples = 1
debug_print_object_batch = False
debug_print_object_batch_steps = 1
debug_print_object_batch_max_samples = 1
debug_print_object_batch_depth_stats = True
cam_drop_prob = 0.1
depth_drop_prob = 0.0
